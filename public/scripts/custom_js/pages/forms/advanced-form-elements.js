$(function () {
    ...
    //Birth-Date
    $demoMaskedInput.find('.birth-date').inputmask('yyyy-mm-dd', { placeholder: '____-__-__' });
    ...
    //Nomor Telepon
    $demoMaskedInput.find('.mobile-nomor-telepon').inputmask('9999-9999-9999', { placeholder: '____-____-____' });
